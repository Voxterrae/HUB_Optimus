...
def ensure_governance_mirrors_for_lang(lang: str):
...
def ensure_all_governance_mirrors():
    for lang in LANGS:
        ensure_governance_mirrors_for_lang(lang)
...
def main():
    ...
    if mode in ("i18n", "full"):
        ensure_all_governance_mirrors()

    print(f"maintenance_bot OK (mode={mode})")
