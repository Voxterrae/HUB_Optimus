...
## What is HUB_Optimus?
HUB_Optimus is a restricted-use, integrity-first framework that helps evaluate
diplomatic and institutional decisions using:
...
Usage is restricted by LICENSE (repo root) and [IP Notice](governance/IP_NOTICE.md).
...
- Name and Identity Use: [governance/TRADEMARKS.md](governance/TRADEMARKS.md)
- Trust Layer (evidence and verification): [governance/TRUST_LAYER.md](governance/TRUST_LAYER.md)
