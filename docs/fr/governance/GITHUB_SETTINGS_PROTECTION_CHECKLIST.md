...
<!-- LOCALIZATION STATUS: stub. Synchronized English source-language copy; not a reviewed translation. -->
...
- Issue `#1681` records the required-check enforcement and its documentation
  evidence. Its completion requires no further GitHub Settings mutation.
- Issue `#1683` records the no-bypass policy and its documentation evidence. Its
  completion requires no further GitHub Settings mutation.
