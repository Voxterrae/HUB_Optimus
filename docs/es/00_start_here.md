...
- [v1_core/](../v1_core/README.md) â†’ NÃºcleo: workflow, plantillas y escenarios (donde ocurre â€œla simulaciÃ³nâ€).
- [legacy/](../context/PROJECT_OVERVIEW.md) â†’ Material histÃ³rico/experimental.
