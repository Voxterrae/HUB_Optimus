...
### Compatibility statement (if permitted)
If a third party is authorized to state compatibility, they must include:
- version reference,
- scope of compatibility,
- explicit statement that they do not control the Kernel.
