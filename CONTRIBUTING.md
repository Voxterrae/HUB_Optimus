...
- `docs/context/STATUS.md` is the source of truth when docs disagree.
- Spanish (`es`) is canonical for `v1_core/languages/*`.
- English (`en`) is maintained as parity reference for validation and accessibility.
