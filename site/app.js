(() => {
  ...
  const translations = {
    en: {
      ...
      noBuild: "Every implementation starts from a documented signal.",
      ...
      portfolioLead: "Every surface carries a status and a direct evidence path. Implemented work is kept separate from prototypes, controlled local components, and RFC-only plans.",
      ...
      boundariesTitle: "One source of truth, explicit execution boundaries.",
      boundariesLead: "GitHub records the authoritative project state. The public site, local tools, and any future private deployments may use that state but cannot redefine it.",
      boundaryTableAria: "Capability boundaries",
      layer: "Layer",
      state: "State",
      authority: "Authority",
      layerGithub: "GitHub repository",
      stateVersioned: "Versioned / traceable",
      authorityCanonical: "Project source of truth",
      layerPages: "Public portfolio",
      stateStatic: "Static site on GitHub Pages",
      authorityNone: "Presentation only",
      stateLocal: "Browser-local / controlled handoff",
      authorityAdvisory: "Draft · no decision authority",
      ...
      statePrivate: "Minimal local CLI",
      authorityContract: "Draft constrained by technical contracts",
      ...
      futureLead: "These documents define constraints for possible future work. They do not prove that a product, deployment, post-quantum control plane, or enterprise service exists.",
      ...
      enterpriseCopy: "Proposed private operating boundary. No enterprise product or public service exists.",
      postQuantumTitle: "Post-quantum control plane",
      postQuantumCopy: "RFC planning around standardized cryptographic primitives. No cryptographic implementation.",
      ...
      footerBoundary: "No embedded client-side analytics or advertising tracking. No hidden scoring. Hosting providers may retain operational logs. GitHub remains authoritative.",
    ...
    es: {
      ...
      noBuild: "Toda implementación parte de una señal documentada.",
      ...
      portfolioLead: "Cada superficie muestra su estado y enlaza directamente con la evidencia. Lo implementado se separa de los prototipos, los componentes locales controlados y los planes que solo existen como RFC.",
      cardCoreLabel: "01 / CORE",
      cardSimulatorLabel: "02 / SIMULADOR",
      cardSemanticLabel: "03 / SEMANTIC ENGINE",
      cardOperatorLabel: "04 / OPERATOR",
      cardIntakeLabel: "05 / INGESTA DE URL",
      ...
      boundariesTitle: "Una única fuente de verdad y límites de ejecución explícitos.",
      boundariesLead: "GitHub registra el estado autoritativo del proyecto. La web pública, las herramientas locales y cualquier futuro despliegue privado pueden utilizar ese estado, pero no redefinirlo.",
      boundaryTableAria: "Límites de capacidades",
      layer: "Capa",
      state: "Estado",
      authority: "Autoridad",
      layerGithub: "Repositorio GitHub",
      stateVersioned: "Versionado / trazable",
      authorityCanonical: "Fuente de verdad del proyecto",
      layerPages: "Portfolio público",
      stateStatic: "Web estática en GitHub Pages",
      authorityNone: "Solo presentación",
      stateLocal: "Local en navegador / transferencia controlada",
      authorityAdvisory: "Borrador · sin autoridad decisoria",
      ...
      authorityContract: "Borrador limitado por contratos técnicos",
      ...
      futureLead: "Estos documentos fijan restricciones para posibles trabajos futuros. No demuestran la existencia de un producto, un despliegue, una capa de control poscuántico ni un servicio empresarial.",
      ...
      enterpriseCopy: "Propuesta de límite operativo privado. No existe ningún producto empresarial ni servicio público.",
      postQuantumTitle: "Capa de control criptográfico poscuántico",
      postQuantumCopy: "Planificación RFC basada en primitivas criptográficas estandarizadas. Sin implementación criptográfica.",
      ...
      footerBoundary: "Este sitio no integra analítica en el navegador ni seguimiento publicitario. No hay puntuación oculta. Los proveedores de alojamiento pueden conservar registros operativos. GitHub sigue siendo la fuente autoritativa.",
    ...
    de: {
      ...
      truthPublicValue: "Statische Website",
      ...
      noBuild: "Jede Umsetzung beginnt mit einem dokumentierten Signal.",
      ...
      portfolioLead: "Jede Oberfläche zeigt ihren Status und verlinkt direkt auf die Evidenz. Implementiertes wird klar von Prototypen, kontrollierten lokalen Komponenten und reinen RFC-Planungen getrennt.",
      cardCoreLabel: "01 / CORE",
      cardSimulatorLabel: "02 / SIMULATOR",
      cardSemanticLabel: "03 / SEMANTIC ENGINE",
      cardOperatorLabel: "04 / OPERATOR",
      ...
      boundariesTitle: "Eine maßgebliche Quelle und klare Ausführungsgrenzen.",
      boundariesLead: "GitHub dokumentiert den maßgeblichen Projektstand. Die öffentliche Website, lokale Werkzeuge und mögliche künftige private Deployments dürfen diesen Stand nutzen, aber nicht neu definieren.",
      boundaryTableAria: "Fähigkeitsgrenzen",
      layer: "Ebene",
      state: "Status",
      authority: "Autorität",
      layerGithub: "GitHub-Repository",
      stateVersioned: "Versioniert / nachvollziehbar",
      authorityCanonical: "Maßgebliche Projektquelle",
      layerPages: "Öffentliches Portfolio",
      stateStatic: "Statische Website auf GitHub Pages",
      authorityNone: "Nur Darstellung",
      stateLocal: "Browser-lokal / kontrollierte Übergabe",
      authorityAdvisory: "Entwurf · keine Entscheidungsbefugnis",
      ...
      authorityContract: "Durch technische Verträge begrenzter Entwurf",
      ...
      futureLead: "Diese Dokumente definieren Grenzen für mögliche künftige Arbeit. Sie belegen nicht, dass ein Produkt, Deployment, eine Steuerungsebene für Post-Quanten-Kryptografie oder ein Unternehmensdienst existiert.",
      ...
      enterpriseCopy: "Vorgeschlagene private Betriebsgrenze. Es gibt weder ein Unternehmensprodukt noch einen öffentlichen Dienst.",
      postQuantumTitle: "Steuerungsebene für Post-Quanten-Kryptografie",
      postQuantumCopy: "RFC-Planung auf Grundlage standardisierter kryptografischer Primitive. Keine kryptografische Implementierung.",
      ...
      footerBoundary: "Diese Website bindet weder clientseitige Analysedienste noch Werbetracking ein. Es findet keine verborgene Bewertung statt. Hosting-Anbieter können Betriebsprotokolle aufbewahren. GitHub bleibt maßgeblich.",
    ...
    ru: {
      ...
      footerBoundary: "На сайте нет встроенной клиентской аналитики и рекламного отслеживания. Скрытое оценивание не применяется. Хостинг-провайдеры могут сохранять служебные журналы. GitHub остаётся авторитетным источником.",
    ...
    he: {
      ...
      footerBoundary: "האתר אינו כולל כלי ניתוח בצד הלקוח או מעקב לצורכי פרסום. אין ניקוד נסתר. ספקי האירוח עשויים לשמור יומנים תפעוליים. GitHub נשאר מקור הסמכות.",
    ...
    "zh-Hans": {
      ...
      footerBoundary: "本站未嵌入客户端分析工具或广告跟踪功能，也不进行隐藏评分。托管服务商可能保留运维日志。GitHub 仍是权威依据。",
