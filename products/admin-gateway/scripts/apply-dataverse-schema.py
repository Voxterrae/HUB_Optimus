...
PROTECTED_MAIN_ANCHOR = "fc5e45d35376184609341ec1b1232ca381c89993"
# Historical contract-review provenance; not a branch ancestry requirement.
...
def encode_odata_relative_path(path: str) -> str:
    ...
    if ODATA_CONTROL_CHARACTER.search(decoded_path) or "\\" in decoded_path:
        raise ApplicatorError("Dataverse request path contains an encoded unsafe character.")
...
class NoRedirectHandler(urllib.request.HTTPRedirectHandler):
    """Never forward a bearer token or replay metadata writes on a redirect."""
